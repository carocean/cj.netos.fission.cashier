...
import cj.netos.fission.model.RechargeRecordExample;
...
public interface RechargeRecordMapper {
    ...
    void updateStatus(@Param(value = "refPaySn") String refPaySn, @Param(value = "status") int status, @Param(value = "message") String message);
}