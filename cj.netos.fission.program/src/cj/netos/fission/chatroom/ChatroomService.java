...
public class ChatroomService extends AbstractService implements IChatroomService {
    ...
    public void enter(String recordSn, String payer, String payerName, String payee, String payeeName) throws CircuitException {
        ...
        addMember(chatroom, payeeFull, payeePerson);
    ...
    private void addMember(Chatroom chatroom, String payeeFull, Person payeePerson) {
        RoomMember member = new RoomMember();
        member.setActor("user");
        member.setAtime(System.currentTimeMillis());
        member.setFlag(0);
        member.setNickName(payeePerson.getNickName());
        member.setPerson(payeeFull);
    ...
    private boolean existsMember(Chatroom chatroom, String payeeFull) {
        return cube(chatroom.getCreator()).tupleCount(_COL_ROOM, String.format("{'tuple.room':'%s','tuple.person':'%s'}", chatroom.getRoom(), payeeFull)) > 0;
    }
    ...
    private Chatroom createChatroom(String payerFull, String roomId, Person payerPerson) {
        ...
        addMember(chatroom,payerFull,payerPerson);
        return chatroom;
    }
